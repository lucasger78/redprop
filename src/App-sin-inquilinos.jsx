...
export default function App() {
  ...
  const supabaseFetch = async (table, params = '') => {
    ...
    // Usar service_role_key para leer visitas (puede tener RLS restrictivo)
    const key = table === 'visitas' ? SUPABASE_SERVICE_KEY : SUPABASE_ANON_KEY;
  ...
  const sharedStyles = `
    ...
    * { box-sizing: border-box; }
    ...
    .sp-form-input, .sp-form-select, .sp-form-textarea { width: 100%; padding: 10px 12px; border: 1px solid #e0dbd4; font-family: 'DM Sans', sans-serif; font-size: 14px; background: #ffffff; color: #333333; outline: none; -webkit-appearance: auto; appearance: auto; }
    .sp-form-input:focus, .sp-form-select:focus, .sp-form-textarea:focus { border-color: #c4a36f; background: #ffffff; }
    .sp-form-select option { background: #ffffff; color: #333333; }
